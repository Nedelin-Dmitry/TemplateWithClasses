...
void SubMenu_work(HANDLE _hStdOut, TextEditor& ZERO) {
    ...
    */
    ...
    do {
        ...
        case 2:
            GetConsoleScreenBufferInfo(_hStdOut, &screen_buffer_info);
            cout << "Введите ширину окна не превышающую " 
                << screen_buffer_info.dwMaximumWindowSize.X << ":" << endl;
            cin >> weight;
            cout << "Введите высоту окна не превышающую " 
        ...
        case 3: 
            GetConsoleScreenBufferInfo(_hStdOut, &screen_buffer_info);
            {
                ...
                do {
                    cout << "Введите положение строки по X не превышающую " 
                    ...
                    For_set_positio.X > screen_buffer_info.dwSize.X - for_control_len);
                do {
                    cout << "Введите положение строки по Y не превышающую:" 
        ...
        case 4:
            ...
            cout << "Введите длину строки больше 0 и не превышающую " 
